...
public class SeleniumComposeContainer extends DockerComposeContainer<SeleniumComposeContainer> {
    ...
    public void isHubRunning() {
        await().until(() -> client.warmingUp(SERVICE_NAME, ofSeconds(10)));
    }

    public void isChromeRunning() {
        await().until(() -> client.warmingUp(CHROME_NAME, ofSeconds(10)));
    }

    public void isFirefoxRunning() {
        await().until(() -> client.warmingUp(FIREFOX_NAME, ofSeconds(10)));
    }
}
